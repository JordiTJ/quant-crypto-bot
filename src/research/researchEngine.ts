    ...
    return [
      {
        ...
        coreIndicators: ['EMA 21/50', 'ADX (14)', 'RSI (14)', 'RVol (20)', 'ATR Volatility-Adjusted Sizing'],
        entryConcept: 'Dynamic 0-100 composite score requiring multi-orthogonal factor alignment (Trend + Momentum + Volume + Volatility)',
        exitConcept: 'Partial profit booking (50% at 1.5R, 25% at 2.5R) + ATR trailing stop on final 25%',
        ...
        compositeRobustness: 91,
        verdict: 'HIGHLY_ROBUST',
        notes: 'Highest consistency across out-of-sample splits. Sizing adapts dynamically to ATR expansions.'
      },
      {
        id: 'strat_a_trend',
      ...
      },
      {
        ...
        name: 'Strategy D: Mean Reversion in Consolidation',
        category: 'Counter-Trend',
        coreIndicators: ['ADX < 20', 'Lower Bollinger Band Touch', 'RSI < 35'],
        entryConcept: 'Strictly applied only in sideways range regime; buys oversold bounce towards 20-period SMA middle band',
        exitConcept: 'Exit at Middle Band (SMA20) or Upper Band',
        idealRegimes: ['SIDEWAYS_RANGE', 'LOW_VOLATILITY'],
        unreliableRegimes: ['STRONG_BULL', 'STRONG_BEAR'],
        sampleWinRate: 64.2,
        profitFactor: 1.35,
        sharpeRatio: 0.95,
        maxDrawdown: 16.5,
        annualizedReturn: 14.2,
        compositeRobustness: 54,
        verdict: 'OVERFIT_RISK',
        notes: 'High win rate (64%) looks tempting, but when an unexpected trend breaks out, large losses hurt overall equity. Modest Sharpe.'
      }
    ];
  }
